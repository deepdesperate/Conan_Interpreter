...
func (vm *VM)Run() error {
	...
	for vm.currentFrame().ip < len( vm.currentFrame().Instructions() )-1 {
		...
		case code.OpReturnValue:
			...
			// // To get just-called *object.CompiledFunction off the stack
			// vm.pop()
...
func (vm *VM)executeBinaryOperation(op code.Opcode) error {
	...
	case leftType == object.STRING_OBJ && rightType == object.STRING_OBJ:
		return vm.executeBinaryStringOeration(op, left, right)
...
func (vm *VM) executeBinaryIntegerOpeartion(
	op code.Opcode,
...
func (vm *VM)executeBinaryStringOeration(op code.Opcode, left, right object.Object) error {
